...
! function(e, t, n) {
    ...
    function o() {
        ...
        for (var u in x)
            if (x.hasOwnProperty(u)) {
                ...
                for (o = r(t.fn, "function") ? t.fn() : t.fn, s = 0; s < e.length; s++) i = e[s], a = i.split("."), 1 === a.length ? Modernizr[a[0]] = o : (!Modernizr[a[0]] || Modernizr[a[0]] instanceof Boolean || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = o), y.push((o ? "" : "no-") + a.join("-"))
            }
    }
    ...
    function u(e, n, r, o) {
        var s, u, l, f, d = "modernizr",
            c = i("div"),
            p = a();
        if (parseInt(r, 10))
            for (; r--;) l = i("div"), l.id = o ? o[r] : d + (r + 1), c.appendChild(l);
        return s = i("style"), s.type = "text/css", s.id = "s" + d, (p.fake ? p : c).appendChild(s), p.appendChild(c), s.styleSheet ? s.styleSheet.cssText = e : s.appendChild(t.createTextNode(e)), c.id = d, p.fake && (p.style.background = "", p.style.overflow = "hidden", f = C.style.overflow, C.style.overflow = "hidden", C.appendChild(p)), u = n(c, e), p.fake ? (p.parentNode.removeChild(p), C.style.overflow = f, C.offsetHeight) : c.parentNode.removeChild(c), !!u
    }
    ...
    function h(e, t, o, s) {
        ...
        for (var d, c, p, h, v, g = ["modernizr", "tspan", "samp"]; !N.style && g.length;) d = !0, N.modElem = i(g.shift()), N.style = N.modElem.style;
        for (p = e.length, c = 0; p > c; c++)
            if (h = e[c], v = N.style[h], l(h, "-") && (h = f(h)), N.style[h] !== n) {
                if (s || r(o, "undefined")) return a(), "pfx" == t ? h : !0;
                try {
                    N.style[h] = o
                } catch (y) {}
    ...
    function v(e, t, n, o, s) {
        ...
        return r(t, "string") || r(t, "undefined") ? h(a, t, o, s) : (a = (e + " " + A.join(i + " ") + i).split(" "), c(a, t, n))
    }
    ...
    var z = "Moz O ms Webkit",
        A = b._config.usePrefixes ? z.toLowerCase().split(" ") : [];
    b._domPrefixes = A, Modernizr.addTest("pointerevents", function() {
        var e = !1,
            t = A.length;
        for (e = Modernizr.hasEvent("pointerdown"); t-- && !e;) T(A[t] + "pointerdown") && (e = !0);
        return e
    });
    ...
    var P = b._config.usePrefixes ? z.split(" ") : [];
    b._cssomPrefixes = P;
    var j = {
        elem: i("modernizr")
    };
    ...
    Modernizr._q.unshift(function() {
            delete N.style
        }), b.testAllProps = v, b.testAllProps = g, Modernizr.addTest("cssanimations", g("animationName", "a", !0)),
        function() {
        ...
        }(), Modernizr.addTest("flexbox", g("flexBasis", "1px", !0)), Modernizr.addTest("flexboxtweener", g("flexAlign", "end", !0)), Modernizr.addTest("csstransforms", function() {
            ...
            if (e && (!t || "webkitPerspective" in C.style)) {
                ...
                Modernizr.supports ? n = "@supports (perspective: 1px)" : (n = "@media (transform-3d)", t && (n += ",(-webkit-transform-3d)")), n += "{#modernizr{width:7px;height:18px;margin:0;padding:0;border:0}}", E(r + n, function(t) {
    ...
    b.mq = B, o(), s(y), delete b.addTest, delete b.addAsyncTest;
