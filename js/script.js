...
(function($) {
    ...
    Plugin.prototype._init = function() {
        ...
        this.miniCart.find('.mini-cart__header').css({
            height: headerHeight,
...
router.route('*all', function() {
    ...
    (function() {
        ...
        $('body').on('mouseenter', '.product-item__inner', function() {
            $(this).find('.product-item__label--hidden').slideDown({
                duration: 250,
                easing: 'swing'
            });
        });
        ...
        $('body').on('mouseleave', '.product-item__inner', function() {
            $(this).find('.product-item__label--hidden').slideUp({
                duration: 250,
                easing: 'swing'
            });
        });
    ...
    (function() {
        ...
        setTimeout(function() {
            ...
            $.cookie('marketing_modal_seen', true, {
                expires: 7
            });
        }, 10000);
    })();
